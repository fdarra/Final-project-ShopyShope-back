          ...
          >
            ...
            <div className="w-2/3 h-[200px] bg-white">
              ...
              <div
                className={
                  edite !== item._id
                    ? "flex mt-2 h-10 items-center contents-center bg-blue-400"
                    : "hidden"
                }
              >
                {/* Stock */}
              ...
              {/* edit Sizes */}
              <div className="w-full pt-0 pl-1  flex text-black bg-red-400 ">
                <div
                  className={
                    edite === item._id
              ...
              <div className="flex justify-end items-end pr-2 mb-2 w-full   bg-slate-600">
                {/* Like button */}
                <button
